...
__all__ = ['lexical', 'embeddings', 'sentiments', 'get_feature',
           'create_feature', 'emotions']
...
def get_feature(f_name):
    ...
    features_dic = dict(
        ...
        char_3=lexical.NGramTfidfVectorizer(ngram_range=(3, 3), analyzer="char",
                                              lowercase=True, min_df=5),
        char_4=lexical.NGramTfidfVectorizer(ngram_range=(4, 4), analyzer="char", lowercase=True, min_df=5),

        char_5=lexical.NGramTfidfVectorizer(ngram_range=(5, 5), analyzer="char", lowercase=True, min_df=5),
        ...
        lex=gender_lexicon.GenderFeatures()
