...
__all__ = [' FasttextFeatures']

class FasttextFeatures(BaseEstimator, VectorizerMixin, TransformerMixin):
    ...
    def fit(self, documents, y=None):
        ...
        if self.model_name:
            ...
            self.model_ = gensim.models.KeyedVectors.load_word2vec_format('wiki-news-300d-1M-subword.vec', limit=999999)
